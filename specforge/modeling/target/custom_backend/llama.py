...
from specforge.distributed import gather_tensor
...
class TensorParallelLlamaDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: LlamaConfig, layer_idx: int):
        ...
        self.self_attn = TensorParallelLlamaAttention(config=config, layer_idx=layer_idx)
...
class LlamaModel(LlamaPreTrainedModel):
    def __init__(self, config: LlamaConfig):
        ...
        self.layers = nn.ModuleList(
            [TensorParallelLlamaDecoderLayer(config, layer_idx) for layer_idx in range(config.num_hidden_layers)]
        )
