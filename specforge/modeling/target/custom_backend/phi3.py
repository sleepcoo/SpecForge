...
from transformers.models.phi3.modeling_phi3 import apply_rotary_pos_emb, eager_attention_forward, Phi3RMSNorm, Phi3RotaryEmbedding

from specforge.distributed import get_tp_group, gather_tensor
...
class Phi3Attention(nn.Module):
    ...
    def __init__(self, config: Phi3Config, layer_idx: Optional[int] = None):
        ...
        self.qkv_proj = ColumnParallelLinear(config.hidden_size, op_size, bias=False, layout_type="merged_qkv")
